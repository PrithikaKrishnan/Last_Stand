...
class Bullets{
    ...
    fall(){
        ...
        if (this.isFalling) {
            ...
            return Bullets.xpoint > this.xpos && Bullets.xpoint < this.xpos + this.width &&
            Bullets.ypoint > this.ypos && Bullets.ypoint < this.ypos + this.height;
        }
...
function isCollided(){
    zombiesList.forEach(zombie =>{
        if(zombie.isCollidingWith(Bullets)){
            console.log("Ammu");
        }})};
